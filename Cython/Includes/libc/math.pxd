cdef extern from "<math.h>" nogil:
    ...
    double fma(double, double, double addend)
    float fmaf(float, float, float addend)
    long double fmal(long double, long double, long double addend)
    ...
    double frexp(double, int* exponent)
    float frexpf(float, int* exponent)
    long double frexpl(long double, int* exponent)
    ...
    double ldexp(double, int exponent)
    ...
    double remquo(double, double, int* quot)
